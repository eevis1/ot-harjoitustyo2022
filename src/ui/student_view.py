...
from services.course_service import course_service, UsernameExistsError


class CourseView:
    """Opiskelijan rekisteröitymisestä vastaava näkymä."""
    ...
    def _register_user_handler(self):
        ...
        try:
            course_service.create_user(username, password)
    ...
    def _initialize(self):
        ...
        self._error_label.grid(padx=6, pady=6)
